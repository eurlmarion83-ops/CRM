...
async function main() {
  ...
  console.log("  Praticien   : dr.martin@medcrm-demo.fr");
  console.log("  Praticienne : dr.benali@medcrm-demo.fr");
  console.log("  Praticien   : dr.lefevre@medcrm-demo.fr");
  console.log("  Secrétaire  : secretariat@medcrm-demo.fr");
  console.log("  Admin       : admin@medcrm-demo.fr");
